...
//			logger.error("Couldn't read config file.");
		...
		router.registerListener(this, new StartDungeon(null, -1, -1, -1));
...
//			router.postEvent(new Stop());
		...
		else if(e instanceof StartDungeon){
			Dungeon dg = ((StartDungeon) e).getDungeon();
			RunnerTest runner = new RunnerTest(dg);
		}
